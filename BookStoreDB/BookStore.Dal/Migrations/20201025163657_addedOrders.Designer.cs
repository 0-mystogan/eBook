...
namespace BookStore.Dal.Migrations
{
    ...
    [Migration("20201025163657_addedOrders")]
            ...
            modelBuilder.Entity("BookStore.Domain.Book", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Author = "Neki_autor1",
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 879, DateTimeKind.Utc).AddTicks(4325),
                        ...
                        new
                        {
                            Id = 2,
                            Author = "Neki_autor2",
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 880, DateTimeKind.Utc).AddTicks(2867),
                            CreatedBy = "jasirbuirc",
                            Currrency = "BAM",
                        ...
                        new
                        {
                            Id = 3,
                            Author = "Neki_autor3",
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 880, DateTimeKind.Utc).AddTicks(2987),
                            CreatedBy = "jasirbuirc",
                            Currrency = "BAM",
                            Description = "Dobar Roman",
                            ModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
            ...
            modelBuilder.Entity("BookStore.Domain.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BookId = 2,
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 889, DateTimeKind.Utc).AddTicks(3720),
                            CreatedBy = "jasirbuirc",
                        ...
                        new
                        {
                            Id = 2,
                            BookId = 2,
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 889, DateTimeKind.Utc).AddTicks(8722),
                            CreatedBy = "jasirbuirc",
                            Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymantMethod = "Paypal",
                        ...
                        new
                        {
                            Id = 3,
                            BookId = 1,
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 889, DateTimeKind.Utc).AddTicks(8816),
                            CreatedBy = "jasirbuirc",
                            Date = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            ModifiedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PaymantMethod = "Paypal",
            ...
            modelBuilder.Entity("BookStore.Domain.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 898, DateTimeKind.Utc).AddTicks(762),
                        ...
                        new
                        {
                            Id = 2,
                            Address = "Halkici 23",
                            CreatedAt = new DateTime(2020, 10, 25, 16, 36, 56, 898, DateTimeKind.Utc).AddTicks(921),
                            CreatedBy = "jasirburic",
